            ...
            <nav class="navbar navbar-expand-lg pl-3 pl-sm-0" style="background-color: rgba(247, 248, 250, 0.8);" id="navbar">
                <div class="container">
                    <div class="navbar-brand-wrapper d-flex w-100">
                        <img src="<?php echo base_url() ?>assets/visitor/images/Group2.svg" alt="">
